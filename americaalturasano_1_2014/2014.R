...
anos_desejados <- c(2014)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Tocantins", "Goiás", "Mato Grosso do Sul", "Minas Gerais")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
