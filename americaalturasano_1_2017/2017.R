...
anos_desejados <- c(2017)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Tocantins", "Goiás", "Minas Gerais", "São Paulo", "Espirito Santo", "Mato Grosso", "Bahia")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
