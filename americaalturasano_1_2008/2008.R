...
anos_desejados <- c(2008)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Tocantins", "Goiás", "Mato Grosso do Sul", "São Paulo", "Paraná", "Rio Grande do Sul" )  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
