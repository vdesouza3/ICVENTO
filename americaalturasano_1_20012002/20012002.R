...
anos_desejados <- c(2001, 2002)  # <- MODIFIQUE AQUI os anos desejados
regioes <- list(                      # <- MODIFIQUE AQUI as regiões (lon_min, lon_max, lat_min, lat_max)
  c(-59, -35, -35, -25),
  c(-52, -25, -25, -12)
)
nomes_regioes <- c("Rio Grande do Sul", "Minas Gerais")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
