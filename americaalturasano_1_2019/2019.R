...
anos_desejados <- c(2019)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Mato Grosso do Sul", "Minas Gerais","São Paulo e Rio de Janeiro", "Paraná", "Santa Catarina")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
