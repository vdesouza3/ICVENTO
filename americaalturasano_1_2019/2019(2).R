...
alturas <- c(120, 150, 180)
# CORREÇÃO: Usando a grafia com acento para Goias
estados_desejados <- c("MINAS GERAIS") 
...
alturas <- c(120, 150, 180)
# CORREÇÃO: Usando a grafia com acento para Goias
estados_desejados <- c("RIO DE JANEIRO") 
...
alturas <- c(120, 150, 180)
# CORREÇÃO: Usando a grafia com acento para Goias
estados_desejados <- c("SANTA CATARINA") 
