...
anos_desejados <- c(2020)  # <- MODIFIQUE AQUI os anos desejados
regioes <- list(                      # <- MODIFIQUE AQUI as regiões (lon_min, lon_max, lat_min, lat_max)
  c(-54, -30, -27.3, -18),
  c(-57, -30, -28, -21),
  c(-55, -30, -31, -24)
)
nomes_regioes <- c("São Paulo", "Paraná", "Santa Catarina")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
