...
anos_desejados <- c(2021)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Paraná", "Santa Catarina", "Rio Grande do Sul", "Minas Gerais")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
