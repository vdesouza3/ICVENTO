...
anos_desejados <- c(2018)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Tocantins", "Goiás", "Minas Gerais", "São Paulo e Rio de Janeiro")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
