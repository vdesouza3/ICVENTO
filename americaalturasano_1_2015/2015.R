...
anos_desejados <- c(2015)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Tocantins", "Goiás", "Minas Gerais", "São Paulo")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
