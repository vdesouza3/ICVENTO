...
anos_desejados <- c(2016)  # <- MODIFIQUE AQUI os anos desejados
...
nomes_regioes <- c("Tocantins", "Goiás", "Minas Gerais", "São Paulo", "Espirito Santo")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
