...
anos_desejados <- c(2000)  # <- MODIFIQUE AQUI os anos desejados
regioes <- list(                      # <- MODIFIQUE AQUI as regiões (lon_min, lon_max, lat_min, lat_max)
  c(-55, -25, -20, -11),
  c(-52, -25, -25, -12)
)
nomes_regioes <- c("Goias", "Minas Gerais")  # <- MODIFIQUE AQUI os nomes das regiões, na mesma ordem de regioes
